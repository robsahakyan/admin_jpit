...
function Header({
  ...
  return (
    <>
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={6}>
          <div className="ant-page-header-heading"></div>
        </Col>
        <Col span={24} md={18} className="header-control">
          <Link to="/sign-in" className="btn-sign-in" onClick={logout}>
            {profile}
            <span>Դուրս գալ</span>
          </Link>
          <Button
              ...
              <div className="header-top">
                <Title level={4}>
                  ...
                  <Text className="subtitle">
                    Ընտրեք Ձեզ հարմար տարբերակ 😇 .
                  </Text>
                </Title>
              </div>

              <div className="sidebar-color">
                <Title level={5}>Գույներ</Title>
                ...
                <div className="sidebarnav-color mb-2">
                  <Title level={5}>Sidenav տեսակը :</Title>
                  <Text>Ընտրեք կողային նավակների 2 տարբեր տեսակների միջև.</Text>
