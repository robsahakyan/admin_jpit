      ...
      <Menu theme="light" mode="inline">
        <Menu.Item key="1">
          <NavLink to="/admin/dashboard">
            ...
            <span className="label">Գլխավոր</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="2">
          <NavLink to="/admin/products">
            ...
            <span className="label">Ապրանքներ</span>
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="3">
          <NavLink to="/admin/users">
            ...
            <span className="label">Օգտատերեր</span>
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="4">
          <NavLink to="/admin/orders">
            ...
            <span className="label">Պատվերներ</span>
          </NavLink>
        </Menu.Item>
      </Menu>
    </>
